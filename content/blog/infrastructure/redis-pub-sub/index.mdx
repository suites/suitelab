---
title: 가볍고 빠른 Message queue를 원한다면 - Redis Publisher, Subscriber
date: '2024-10-18'
category: 'infra'
emoji: '💌'
slug: 'redis-pub-sub'
...
Redis의 pub/sub은 MSA에서 모듈간의 데이터 교환을 위해 사용되는 Message Queue의 용도로 redis를 활용하는 방법이다.
...
메시지 큐는 메시지를 임시 저장하여 수신자가 처리할 준비가 될 때까지 보관할 수 있다. 발신자와 수신자의 메시지 전달 속도를 조절하여 시스템의 부하를 분산하고 안정성을 높이는데 도움이 된다.
