...
category: 'web'
emoji: '🕺'
slug: 'how-to-setup-free-ssl-2'
---

> 이전글 : [무료로 내 블로그에 SSL[HTTPS] 적용하기](https://fredly.dev/web-how-to-setup-free-ssl/)
...
```shell
$ dig fredly.dev +nostats +nocomments +nocmd

; <<>> DiG 9.11.3-1ubuntu1.1-Ubuntu <<>> fredly.dev +nostats +nocomments +nocmd
;; global options: +cmd
;fredly.dev.                     IN      A
fredly.dev.              600     IN      A       185.199.108.153

$ dig fredly-dev.github.io +nostats +nocomments +nocmd

; <<>> DiG 9.11.3-1ubuntu1.1-Ubuntu <<>> fredly-dev.github.io +nostats +nocomments +nocmd
;; global options: +cmd
;fredly-dev.github.io.            IN      A
fredly-dev.github.io.     600    IN      A       185.199.108.153
```
