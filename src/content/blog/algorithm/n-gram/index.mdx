...
위에 대한 소스코드는  
[https://github.com/suites/actual-deeplearning/blob/master/ch6/lev-distance.py](https://github.com/suites/actual-deeplearning/blob/master/ch6/lev-distance.py)  
[https://github.com/suites/actual-deeplearning/blob/master/ch6/ngram-test.py](https://github.com/suites/actual-deeplearning/blob/master/ch6/ngram-test.py)  
에 올려두었다.
